...
adipose_thickness_array = [4];
muscle_thickness_array = [10];

%Saturation array
SatO2_muscle_array = [0.6]; %0.6 0.8
SatO2_placenta_array = [0.8];


%HbT array
% C_HbT_muscle_array = [15,25,35,50]*1e-6;
% C_HbT_placenta_array = [15,25,35,50]*1e-6;
C_HbT_muscle_array = [25]*1e-6;
C_HbT_placenta_array = [25]*1e-6;
...
%fileList = dir(strcat('output_lookup_table/out_St_muscle_',num2str(SatO2_muscle_array(1)),'_St_placenta_',num2str(SatO2_placenta_array(1)),'*_HbT_muscle_umol_',num2str(C_HbT_muscle_array(1)*1e6),'_HbT_placenta_umol_',num2str(C_HbT_placenta_array(1)*1e6),'.mat'));
        ...
        for SatO2_muscle = SatO2_muscle_array
            ...
            for SatO2_placenta = SatO2_placenta_array
				...
				%end
                                ...
                                Sensitivity_maps = zeros(8,size(cfg.vol,1),size(cfg.vol,2),size(cfg.vol,3));
                                Mean_path = zeros(8,1);
